...
<html lang="tr">
    <head>
        ...
        <title>İletişim - Nos Studio</title>
    ...
    <body class="topics-listing-page" id="top">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($name) && !empty($email) && !empty($subject) && !empty($message_text)) {
                $to = "info@nosstudio.com";
                $headers = "From: $email\r\n";
                $headers .= "Reply-To: $email\r\n";
                $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
                
                $email_content = "İsim: $name<br>";
                $email_content .= "E-posta: $email<br>";
                $email_content .= "Konu: $subject<br>";
                $email_content .= "Mesaj: $message_text<br>";
                
                if(mail($to, $subject, $email_content, $headers)) {
                    $message = '<div class="alert alert-success">Mesajınız başarıyla gönderildi!</div>';
                } else {
                    $message = '<div class="alert alert-danger">Mesaj gönderilirken bir hata oluştu.</div>';
                }
            } else {
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-4">Sizden haber almaktan mutluluk duyarız</h2>

                            <p>Stüdyomuz hakkında bilgi almak, randevu oluşturmak veya sorularınız için bize ulaşın.</p>
                            <?php echo $message; ?>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="custom-form contact-form" role="form">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12"> 
                                        <div class="form-floating">
                                            <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="E-posta adresi" required>
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-floating">
                                            <input type="text" name="subject" id="subject" class="form-control" placeholder="Konu" required>
                                            
                                            <label for="subject">Konu</label>
                                        </div>

                                        <div class="form-floating">
                                            <textarea class="form-control" id="message" name="message" placeholder="Proje hakkında bana bilgi verin" required></textarea>
                                            
                                            <label for="message">Proje hakkında bana bilgi verin</label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5 col-12 mx-auto mt-5 mt-lg-0">
                            ...
                            <h5 class="mt-4 mb-2">Konu Listeleme Merkezi</h5>
